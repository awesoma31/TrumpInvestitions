...
#### 2. Nginx proxy (централизованный вход в систему)
...
- прокидывание запросов на API Gateway
...
1.2 Возможность просмотра всех акций списком
1.3 Возможность просмотра всех Bid/Ask в виде списка для каждой акции

2. **Совершение торговых операций**
2.1 Возможность создать заявку
2.2 Возможность купить/продать акцию или пакет акций по заявке
2.3 Система автоматически отменяет заявку, если на рынке не хватает нужного количества акций для исполнения заявки
...
5.1.2 Получение ответов от микросервисов
5.1.3 Логирование всех операций и мониторинг доступности
