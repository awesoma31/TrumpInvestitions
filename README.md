...
1.1.1 Отображение списка котировок (Highest Bid, Lowest Ask) для каждой акции на клиентском UI
...
1.3 Возможность просмотра всех Bid/Ask в виде списка для каждой акции

2. **Совершение торговых операций**
2.1 Возможность создать/отменить заявку
2.2 Возможность купить/продать акцию или пакет акций по заявке

3. **Управление инвестиционным портфелем**
3.1 Просмотр состания портфеля
3.1.1 Просмотр историии сделок
3.1.2 Расчёт доходности PnL
3.1.3 Просмотр списка текущих акций, находящихся в собственности пользователя
