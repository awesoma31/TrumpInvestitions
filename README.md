...
2.1 Возможность купить/продать акцию или пакет акций по заявке
2.2 Система автоматически отменяет заявку, если на рынке не хватает нужного количества акций для исполнения заявки
