...
**Обмен**: Pub/Sub через брокер сообщений.
...
**Обмен:** события в брокер сообщений (**Redis**).
...
#### 5. Брокер сообщений (Redis Server)
...
1.1.1 Отрисовка котировок на клиентском UI в виде графика зависимости цены от времени
1.1.2 Отрисовка истории цены отдельной акции на клиентском UI в виде графика зависимости цены от времени
...
3.1 Просмтор состания портфеля
3.1.1 Просмотор историии сделок
3.1.3 Расчёт доходности PnL
3.1.4 Просмотор списка текущих акций, находящихся в собственности пользователя
...
5.1.3 Публикация запросов в брокер сообщений Redis
...
3. данные:
    - публикуются в Redis Pub/Sub (для realtime)
